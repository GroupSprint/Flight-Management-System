...
public class ScheduledFlightController {
	...
	// scheduled flight details by source and destination airport
	@GetMapping("/viewAllScheduledFlightsbyAirport/{sAirport}/{dAirport}/{date}")
	public ResponseEntity<List<ScheduledFlight>>viewAllScheduledFlightsbyAirport(@RequestBody Airport sAirport,
			@RequestBody Airport dAirport,@RequestParam("date") @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDateTime date){

		LOG.info(" ResponseEntity<List<ScheduledFlight>>  viewAllScheduledFlightsbyAirport()");
		List<ScheduledFlight> scheduledFlightData=service.viewAllScheduledFlightsbyAirport(sAirport, dAirport, null);
		return new ResponseEntity<List<ScheduledFlight>>(scheduledFlightData,HttpStatus.OK);
	}
}
